...
from myapp.views import coordinator_student_reports_view, coordinator_student_detail_view, intern_login_view, coordinator_submit_update_view, chairman_coordinator_detail_view
from . import views
...
urlpatterns = [
    ...
    path('chairman/coordinator/<int:coordinator_id>/', chairman_coordinator_detail_view, name='chairman_coordinator_detail'),
